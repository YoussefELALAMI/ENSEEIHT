...
(******************************************************************************)
(*   fonction de retrait un éléments d'un arbre binaire                       *)
(*   signature  : ajout : 'a list -> 'a arbre -> 'a arbre                     *)
(*   paramètres : - une liste d'éléments                                      *)
(*                - un arbre n-aire                                           *)
(*   résultat   : l'arbre n-aire sans le mot concerné                         *)
(******************************************************************************)
...
(* Arbres pour tester le retrait*)  
let ar_avant_retrait_mot_bas = List.fold_right ajout_arbre
[['b';'a';'s']; ['b';'a';'t']; ['d';'e']; ['l';'a']; ['l';'a';'i'];
 ['l';'a';'i';'d']; ['l';'a';'i';'t']; ['l';'a';'r';'d']; ['l';'e'];
 ['l';'e';'s']; ['l';'o';'n';'g']]
(Noeud (false,[]))           
let ar_apres_retrait_mot_bas = List.fold_right ajout_arbre
[['b';'a';'s'; 'c']; ['b';'a';'t']; ['d';'e']; ['l';'a']; ['l';'a';'i'];
 ['l';'a';'i';'d']; ['l';'a';'i';'t']; ['l';'a';'r';'d']; ['l';'e'];
 ['l';'e';'s']; ['l';'o';'n';'g']]
(Noeud (false,[]))

(*test*)
let%test _ = retrait_arbre ['b','a','s'] ar_avant_retrait_mot_bas = ar_apres_retrait_mot_bas
