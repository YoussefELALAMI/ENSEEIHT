// Time-stamp: <28 oct 2022 10:17 queinnec@enseeiht.fr>
...
public class IHMLectRed
{
    ...
    private void checkValidState() {
        ...
        if (((nl > 0) && (nr > 0)) || (nr > 1)) {
            System.err.println("Attention : état potentiellement invalide nblect="+nl+" nbred="+nr);
    ...
    /****************************************************************/
    public IHMLectRed(LectRed _lr, Synchro.Simulateur _simu) {
        nbLecteurs = 0;
        nbRedacteurs = 0;
        simu = _simu;
        lr = _lr;
