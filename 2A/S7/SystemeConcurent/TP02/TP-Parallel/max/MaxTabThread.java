...
public class MaxTabThread {
    ...
    private static int computeMax(int[] array, int numberOfThreads) throws InterruptedException {
        ...
        /* XXXX À COMPLÉTER (FAIT) XXXX */

        // Récupérer les Threads (activités = jobs)
        List<PartialMax> activites = new ArrayList<PartialMax>();
        int startIndex = 0;
        ...
        // Lancer les Threads (activités = jobs)
        for (PartialMax a : activites){
