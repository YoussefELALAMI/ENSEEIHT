...
pasMiam1(rive) == 
    /\ ((EntitesC \intersect rive) /= {}) => ((Cardinality(EntitesM \intersect rive) \geq  Cardinality(EntitesC \intersect rive)))
...
\* Last modified Thu Feb 08 09:46:00 CET 2024 by yelalami
