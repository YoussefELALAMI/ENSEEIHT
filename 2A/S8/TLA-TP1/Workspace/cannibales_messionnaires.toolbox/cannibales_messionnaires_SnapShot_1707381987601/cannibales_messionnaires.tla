...
pasMiam1(rive) == 
    /\ ((EntitesM \intersect rive) /= {}) => ((Cardinality(EntitesM \intersect rive) \geq  Cardinality(EntitesC \intersect rive)))
...
\* Last modified Thu Feb 08 09:46:23 CET 2024 by yelalami
