...
UneSeuleFourchetteDroite == [](Cardinality(\A i \in Philos : etatFourchette[fourchetteDroite(i)]) = 1)
...
utiliserFouchetteDroite(i) ==
    ...
    /\ etatFourchette' = [ etatFourchette EXCEPT ![fourchetteDroite(i)] = AssietteDroite ]
    /\ UNCHANGED etat
    
utiliserFouchetteGauche(i) ==
    /\ etatFourchette[fourchetteGauche(i)] = Libre
    /\ etatFourchette' = [ etatFourchette EXCEPT ![fourchetteGauche(i)] = AssietteGauche ]
    /\ UNCHANGED etat
...
Fairness == \A i \in Philos :
              ...
              /\ WF_<<etat,etatFourchette>> (utiliserFouchetteDroite(i))
              /\ WF_<<etat,etatFourchette>> (utiliserFouchetteGauche(i))
