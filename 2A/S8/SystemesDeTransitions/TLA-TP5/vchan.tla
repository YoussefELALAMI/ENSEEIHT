...
SenderSPIT == /\ SenderIT' = TRUE
             /\ UNCHANGED << Sent, Got, ReceiverState, ReceiverIT, SenderState, Buffer, SenderLive, msg, NotifyWrite, NotifyRead, ReceiverLive >>
\* A ReceiverIT spuriously appears.
ReceiverSPIT == /\ ReceiverIT' = TRUE
             /\ UNCHANGED << Sent, Got, ReceiverState, SenderIT, SenderState, Buffer, SenderLive, msg, NotifyWrite, NotifyRead, ReceiverLive >>
----------------

SenderNext == SenderIdle1 \/ SenderIdle2 \/ SenderWrite1 \/ SenderWrite2 \/ SenderWriteNext1 \/ SenderWriteNext2 \/ SenderUnblock1 \/ SenderUnblock2 \/ SenderEnd \/ SenderSPIT

ReceiverNext == ReceiverIdle1 \/ ReceiverIdle2 \/ ReceiverIdle3 \/ ReceiverRead \/ ReceiverReadNext \/ ReceiverUnblock \/ ReceiverEnd \/ ReceiverSPIT
