...
SenderUnblock2 == /\ SenderState = Blocked
                  ...
                  /\ SenderIT' = FALSE
                  /\ SenderState' = Done
                  /\ UNCHANGED << Sent, Got, SenderLive, Buffer, ReceiverState, msg, NotifyWrite, NotifyRead, ReceiverIT, ReceiverLive >>
...
SenderClose == /\ SenderLive
               /\ SenderLive' = FALSE
               /\ ReceiverIT' = TRUE
               /\ UNCHANGED << Sent, Got, ReceiverState, ReceiverIT, SenderState, Buffer, SenderIT, msg, NotifyWrite, NotifyRead >>
